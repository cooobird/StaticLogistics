...
import com.coobird.staticlogistics.network.c2s.C2SGroupActionPayload;
...
public class SLEvents {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(C2SGroupActionPayload.TYPE, C2SGroupActionPayload.STREAM_CODEC, C2SGroupActionPayload::handle);
    }
