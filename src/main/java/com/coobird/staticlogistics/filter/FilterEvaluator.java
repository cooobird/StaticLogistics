...
public class FilterEvaluator {
    ...
    private static boolean testItemFilters(ItemStack stack, FilterData filter, UpgradeType upgradeType) {
        ...
        boolean tagPass = !hasTagFilter || new TagLogisticsFilter(Collections.emptySet(), Collections.emptySet(), Collections.emptySet(), Collections.emptySet(), true).test(stack, isBlacklist);
