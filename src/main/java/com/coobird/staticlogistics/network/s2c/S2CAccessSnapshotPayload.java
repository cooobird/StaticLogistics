...
public record S2CAccessSnapshotPayload(
    ...
    public static final ResourceLocation ID = StaticLogistics.asResource("access_snapshot");
    ...
    public static final PortStreamCodec<PortRegistryFriendlyByteBuf, S2CAccessSnapshotPayload> STREAM_CODEC =
        new PortStreamCodec<>() {
            @Override
            public S2CAccessSnapshotPayload decode(PortRegistryFriendlyByteBuf buffer) {
            ...
            @Override
            public void encode(PortRegistryFriendlyByteBuf buffer, S2CAccessSnapshotPayload payload) {
