...
public class SLLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("config.staticlogistics.mek_gas_stack_size.tooltip", "Base Mekanism gas amount moved by one transfer.", "单次传输移动的基础 Mekanism 气体数量。");
        add("config.staticlogistics.mek_infusion_stack_size", "Base Mek Infusion Amount", "基础 Mek 灌注传输量");
        add("config.staticlogistics.mek_infusion_stack_size.tooltip", "Base Mekanism infusion amount moved by one transfer.", "单次传输移动的基础 Mekanism 灌注数量。");
        add("config.staticlogistics.mek_pigment_stack_size", "Base Mek Pigment Amount", "基础 Mek 颜料传输量");
        add("config.staticlogistics.mek_pigment_stack_size.tooltip", "Base Mekanism pigment amount moved by one transfer.", "单次传输移动的基础 Mekanism 颜料数量。");
        add("config.staticlogistics.mek_slurry_stack_size", "Base Mek Slurry Amount", "基础 Mek 浆液传输量");
        add("config.staticlogistics.mek_slurry_stack_size.tooltip", "Base Mekanism slurry amount moved by one transfer.", "单次传输移动的基础 Mekanism 浆液数量。");
        ...
        add("config.staticlogistics.gtceu_stack_size.tooltip", "Base GregTech EU amount moved by one transfer.", "单次传输移动的基础 GregTech EU 数量。");
