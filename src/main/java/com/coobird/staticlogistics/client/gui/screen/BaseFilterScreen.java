...
public abstract class BaseFilterScreen<T extends AbstractFilterMenu>
    ...
    public void render(GuiGraphics graphics, int mx, int my, float pt) {
        ...
        if (menu.getActiveUpgradeType() == UpgradeType.NBT_FILTER) {
            NbtModeControls.renderTooltip(graphics, this.font, leftPos, topPos,
                mx, my, menu.getNbtMatchMode());
        }
    }
    ...
    public void containerTick() {
        super.containerTick();
        if (isTagMode()) {
            TagBarWidget.clearOrphanedSlotTags(this, this, true, this::sendFilterUpdate);
        }
    }
