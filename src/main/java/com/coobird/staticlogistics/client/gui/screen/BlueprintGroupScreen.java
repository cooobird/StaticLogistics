...
public class BlueprintGroupScreen extends Screen {
    ...
    private void syncSettings(GroupRef group) {
        ...
        PortItemStackExtension.setData(stack, SLDataComponents.SELECTED_GROUP_KEY.get(), groupKey);
        SelectionContext.setSelection(groupId, groupKey, 0);
        SLNetwork.HANDLER.sendToServer(
            new C2SUpdateToolSettingsPayload(groupId, groupKey, 0, java.util.List.of(),
