...
public class LogisticsRenderHelper {
    ...
    public static void renderBox(VertexConsumer b, Matrix4f mat,
        ...
        b.vertex(mat, x2, y2, z1).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y2, z1).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y1, z2).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y2, z2).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x2, y2, z2).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x2, y1, z2).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y1, z1).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y2, z1).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y2, z2).color(ir, ig, ib, ia).endVertex();
        b.vertex(mat, x1, y1, z2).color(ir, ig, ib, ia).endVertex();
