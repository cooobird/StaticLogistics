...
public class SelectionContext {
    ...
    public static void syncFromItem(ItemStack stack) {
        selectedGroupId = PortItemStackExtension.getDataOrDefault(stack, SLDataComponents.SELECTED_GROUP.get(), "");
        selectedMode = PortItemStackExtension.getDataOrDefault(stack, SLDataComponents.TOOL_MODE.get(), 0);
    }
}
